...
Once we have identified the user story we can use them to plan our development sprints aronud those required tasks. This step should not get into any technical language or technologies, remember it is from the perspective of the user.

We use common the user description template of:
...
This will get placed on cards(physical or digital) so that they can be visually laid out and discussed among the team.
...
The MVP is the "minimal viable product". The MVP is the least amount of development you can do to get your product in front of users. This means that you get a working version of your app out into production quickly. This means you can start getting user feedback sooner. Getting timely user feedback means that you will minimize time wasted on unwanted or uneeded features that maybe you thought the user wanted.

Once your MVP is launched you can determine if the interest in your app is worth continuing on with development whether your app better suits another market or to just cut your losses and ditch the project.
